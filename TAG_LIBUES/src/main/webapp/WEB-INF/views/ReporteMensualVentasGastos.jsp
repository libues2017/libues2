...
String tipoEspec= request.getParameter("especificoGastos");
String consigna= request.getParameter("consignacion");
...
parameters.put("especTipo", tipoEspec); 
parameters.put("consg", consigna); 
